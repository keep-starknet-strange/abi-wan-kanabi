export const ABI = [
  ...
  },
  {
    ...
    "variants": [
      { "name": "Some", "type": "core::option::Option::<core::integer::u8>" },
      { "name": "None", "type": "()" }
    ]
  },
  {
    ...
    "members": [
      { "name": "int128", "type": "core::integer::u128" },
      { "name": "felt", "type": "core::felt252" },
      { "name": "tuple", "type": "(core::integer::u32, core::integer::u32)" }
    ]
  },
  {
    "type": "enum",
    ...
    "items": [
      {
        "type": "function",
        "name": "fn_felt",
        "inputs": [{ "name": "felt", "type": "core::felt252" }],
        "outputs": [],
      ...
      },
      {
        ...
        "inputs": [
          { "name": "felt", "type": "core::felt252" },
          { "name": "int8", "type": "core::integer::u8" },
          { "name": "b", "type": "core::bool" }
        ],
        "outputs": [],
        "state_mutability": "view"
      },
      ...
      },
      {
        ...
        "inputs": [],
        "outputs": [{ "type": "core::option::Option::<core::integer::u8>" }],
        "state_mutability": "view"
      },
      {
        "type": "function",
      ...
      },
      {
        ...
        "inputs": [
          { "name": "arg", "type": "core::array::Array::<core::integer::u8>" }
        ],
        "outputs": [],
        "state_mutability": "view"
      },
      ...
      },
      {
        "type": "function",
        "name": "fn_struct",
        "inputs": [{ "name": "arg", "type": "example::TestStruct" }],
        "outputs": [],
        "state_mutability": "view"
      },
      {
      ...
      },
      {
        "type": "function",
        "name": "fn_enum",
        "inputs": [{ "name": "arg", "type": "example::TestEnum" }],
        "outputs": [],
        "state_mutability": "view"
      },
      {
        ...
        "name": "fn_enum_array",
        "inputs": [
          { "name": "arg", "type": "core::array::Array::<example::TestEnum>" }
        ],
        "outputs": [],
        "state_mutability": "view"
      },
      {
        ...
        "inputs": [],
        "outputs": [{ "type": "core::array::Array::<example::TestEnum>" }],
        "state_mutability": "view"
      }
    ]
  },
  ...
  },
  {
    ...
    "kind": "struct",
    "members": [
      { "name": "member", "type": "core::integer::u128", "kind": "data" }
    ]
  },
  {
    "type": "event",
